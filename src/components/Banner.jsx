        ...
        <div style={{
            ...
            <div className="lg:pl-32 lg:w-7/12 flex flex-col justify-between lg:py-20">
                <div className="flex flex-col lg:px-0 px-10">
                    <span className='text-left font-vazirmatn lg:text-9xl text-7xl'>ALEKSEI</span>
                    <div className='text-right lg:pl-64'>
                        <span className='font-vazirmatn lg:text-9xl text-7xl'>SELETCKII</span>
                        <p className='lg:text-2xl pt-10 text-left hidden lg:block'>Software Engineer - TypeScript | React | JavaScript | ExpressJS | NodeJS | NextJS | MongoDB | PostgreSQL</p>
                    </div>
                </div>
