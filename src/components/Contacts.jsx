    ...
    <div id="Contact" className="p-4 lg:p-20 flex flex-col items-center justify-center">
        ...
        <form action="" className="flex flex-col gap-2 lg:w-1/2">
            <div className="lg:flex gap-9">
                ...
                <input className="w-full lg:my-3 my-4 rounded-lg bg-slate-800 p-4 border-2 border-purple b_glow text-xl text-slate-500" placeholder="Enter Your Email" type="text" />
            </div>
            <textarea className="w-full my-3 rounded-lg bg-slate-800 p-4 border-2 border-purple b_glow text-xl text-slate-500" placeholder="Write Your Massage..." name="" id="" cols="20" rows="10"></textarea>
