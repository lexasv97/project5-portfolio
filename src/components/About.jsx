  ...
  return (
    <div id='About' className="lg:px-56 px-10 lg:py-0 py-20 text-center gap-5 lg:text-start flex lg:flex-row flex-col justify-between lg:gap-28 items-center">
            ...
            <div className=" h-full lg:py-40 flex flex-col justify-center lg:items-start items-center">
                ...
                <p data-aos="fade-left" className="mb-6">I'm a Full Stack Developer, I have a passion for creating and implementing innovative web solutions, using cutting-edge technologies and best practices. I graduated from Ironhack, a leading tech bootcamp, where I learned the latest skills and tools in web development, such as JavaScript React.js, Express.js, Node.js, MongoDB, Tailwind, HTML, and CSS. Then I continued with TypeScript. I also hold a bachelor's degree in Computer Software Engineering from MIET, a prestigious tech university in Russia.</p>
                <p data-aos="fade-right">I am a highly motivated and result-driven developer, looking for opportunities that will provide me both personal and professional growth. I have the ability to work in a fast, agile environment with frequent change, and I have excellent technical, communication, and interpersonal skills. I am eager to learn new technologies and frameworks. I am ready for challenges and excited to work on innovative projects that make a positive impact.</p>
